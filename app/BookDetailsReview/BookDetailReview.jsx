        ...
        <main className="main">
          ...
          <section className="section-box  background-card">
            <div className="container pt-1">
              ...
              <p className="text-xl-bold neutral-900 mt-10 heading">
                Flight Booking
              </p>
                         ...
                         <button className="border border-grey rounded">More</button>
                          ...
                          <div className=" border flex flex-row justify-between items-center rounded-md mb-4 shadow-md  p-3">
                            <div>
                              ...
                              <p>
                                Till- June-3,2025 9:14 | Time Left:00:00:00{" "}
                              </p>
                          ...
                          <div className="shadow rounded-md p-3">
                            ...
                            <div className="flex flex-col justify-start  items-start">
                              ...
                              <div className="flex flex-row gap-3 items-center mb-2">
                                <p className="lg:text-xl-bold neutral-1000 cityname">
                                  {"DELHI"}
                                  {/* <span>({dcitycode})</span> */}
                                </p>
                                <svg
                          ...
                          <p className="text-sm-medium neutral-500">{aterminal}</p>]
                            ...
                            <div className="flex flex-col justify-start mb-5 md:flex-row md:justify-between md:mb-0">
                              ...
                              <div className="flex flex-row items-center gap-3 ">
                                <p className="text-sm-medium neutral-500 flightdetails ">
                                  cabinclass
                                </p>
                                <span
                            ...
                            <div className=" ticketdiv  bg-gray-100  rounded-md  space-y-6 ">
                              ...
                              <div className="flex flight-timings   w-full ">
                                <div className="text-left space-y-1">
                                  ...
                                  <p className=" neutral-500 airportname ">
                                    dairportname
                                  </p>
                                  <p className=" neutral-1000 terminal ">
                                    terminal
                                  </p>
                                </div>

                                <div className="text-center space-y-1">
                                  <p className="text-sm-medium neutral-500 duration ">
                                    2h 25m
                                  </p>
                                  <img
                                    src="https://edge.ixigo.com/st/vimaan/_next/static/media/line.9641f579.svg"
                                    alt="flight line"
                                    className="mx-auto w-20 durationsvg"
                                  />
                                </div>
                                ...
                                <div className="text-right space-y-1">
                                  ...
                                  <p className="text-sm-medium neutral-500 airportname ">
                                    aairportname
                                  </p>
                                  <p className="text-sm-medium neutral-1000 terminal">
                                    aterminal
                                  </p>
                                </div>
                                {/* Baggage Info */}
                                <div className="flex flex-col items-start baggageinfo  ">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <p className="text-sm-bold neutral-900 cabindetails">
                                      Cabin:{" "}
                                      <span className="text-sm-medium neutral-500 cabindetails">
                            ...
                            >
                              ...
                              >
                                <div className="ant-form-item">
                                  <p className="text-xl-bold neutral-1000 mb-10 heading ">
                                  ...
                                  <div className="overflow-x-auto w-full">
                                    <table className="w-max border-collapse mb-20 ">
                                      ...
                                      >
                                        <tr>
                                          <th className="px-4 py-2 text-left text-gray-600 border-b border-gray-300 t-head">
                                            S.No
                                          </th>
                                          <th className="px-4 py-2 text-left text-gray-600 border-b border-gray-300 t-head">
                                            Mr/Mrs
        ...
        <tr key={index}>
          ...
          <td className="px-4 py-3 border-b border-gray-200 text-black">
            {traveller?.lN?.trim() || "N/A"}
                                        ...
                                        <tr>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black t-value">
                                            1
                                          </td>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black t-value">
                                            N/A
                              ...
                              >
                                <p className="text-lg-bold neutral-1000 mb-10 heading">
                                  Contact information
                                </p>
                                <div className="ant-form-item">
                                  <div className="text-md neutral-1000 contactinfo  ">
                                    Email:{" "}
                                    <strong>{"No email available"}</strong>{" "}
                                  </div>
                                  <div className="text-md neutral-1000 contactinfo ">
                                    Phone Number:{" "}
                                    <strong>
                                ...
                                <div className="ant-form-item">
                                  ...
                                  <div className="overflow-x-auto w-full">
                                    <table className="w-max border-collapse mb-20">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black w-max t-value">
                                            Jun 2, 2025 11:06 AM
                                          </td>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black t-value">
                                            Deposit
                                          </td>
                                          <td className="px-4 py-3 border-b border-gray-200 text-blue-600 t-value">
                                            TJS100301470098
                                          </td>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black t-value">
                                            Paid For Order
                                          ...
                                          <td className="px-4 py-3 border-b border-gray-200 text-green-600 t-value">
                                            Success
                                          </td>
                                          <td className="px-4 py-3 border-b border-gray-200 text-black t-value">
                                            ₹16,473.00
                                      ...
                                      <tfoot>
                                        <tr>
                                          <td className="px-4 py-3 border-t font-bold text-black">
                                            Total
                                          </td>
                                          <td
                                            ...
                                            colSpan={3}
                                          ></td>
                                          <td className="px-4 py-3 border-t text-black font-bold">
                                            ₹0.00
                                          </td>
                                          <td className="px-4 py-3 border-t text-black font-bold">
                                            ₹16,473.00
