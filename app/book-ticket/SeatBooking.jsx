...
const SeatBooking = ({ numAdults, numChild, apiData }) => {
  ...
  const renderSeatMap = (sInfo) => {
    ...
    const alreadySelectedSeats = seatSelections
                    ...
                    <tbody>
                      {[...Array(numAdults)].map((_, index) => (
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-gray-700">
                            {seatSelections[index]?.cost ||
                            seatSelections[index]?.cost == "0"
                              ? `₹ ${seatSelections[index]?.cost}`
                              : "—"}
                          </td>
                        </tr>
                        ...
                        [...Array(numChild)].map((_, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-2 py-2 text-gray-700">
                                {seatSelections[passengerIndex]?.cost ||
                                seatSelections[passengerIndex]?.cost == "0"
                                  ? `₹${seatSelections[passengerIndex].cost}`
                                  : "—"}
                              </td>
                            </tr>
