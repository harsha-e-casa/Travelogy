...
import TopCategory2 from "@/components/sections/TopHotels2";
                  ...
                  <li>
                    ...
                    <div className="step-info">
                      ...
                      <p className="text-sm-medium neutral-500">
                       Enter destination, dates, and preferences to view available hotels.
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="step-info">
                      ...
                      <p className="text-sm-medium neutral-500">
                       Pick the room type, amenities, and package that suits you.
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="step-info">
                      ...
                      <p className="text-sm-medium neutral-500">
                        Fill in personal details, ID proof, and special requests.
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="step-info">
                      ...
                      <p className="text-sm-medium neutral-500">
                       Complete secure payment and receive instant booking confirmation.
                      </p>
                    </div>
                  </li>
                </ul>
