    ...
    <div className="max-w-4xl p-6 rounded-md text-sm space-y-6">
      ...
      <>
        ...
        {hotelReviewData?.query?.roomInfo?.map((room, roomIndex) => {
          ...
          const currentAdults = extraGuests.filter((g) => g.type === "adults");
                ...
                currentChildren.length < room.numberOfChild ? (
                  <button
                    onClick={() => {
                      ...
                      } else if (currentChildren.length < room.numberOfChild) {
    ...
    <div className="max-w-5xl mx-auto p-6 rounded-md text-sm space-y-6">
      ...
      <div className="border-t pt-4">
        ...
        <ul className="text-xs text-gray-700 list-decimal ml-6 space-y-1">
          ...
          <li>
            Your booking is confirmed. However, your name will be listed in the
            hotel’s reservation system closer to your arrival date.
          </li>
          ...
          <li>
            In case of incorrect residency and nationality chosen by the user at
            the time of booking, additional charges may be applicable which will
            be borne by the guest and paid to the hotel at the time of
            check-in/check-out.
          </li>
          <li>
            Any special requests are all subject to availability at the time of
            check-in and are not guaranteed at the time of booking (bed type,
            smoking room, early check-in, late check-out etc.).
          </li>
          <li>
          ...
          <li>
            Hotels do not permit unmarried or unrelated couples and it is at the
            hotel management’s discretion to allow or cancel the booking. In
            such case no refund is applicable if the hotel disallows check-in.
          </li>
          <li>
          ...
          <li>
            If your booking offers complimentary car transfer you need to inform
            the hotel of your travel details 24 hours prior to check-in.
          </li>
          <li>
            As per RBI guidelines: in case of foreign nationals, it is mandatory
            to submit a passport copy of the guest. Please send a scanned copy
            of the guest's passport to us. Failure to comply may result in the
            cancellation of the booking without notice.
          </li>
          <li>
            Additional GST Payment (if any) to be paid to the hotel directly by
            the guest.
          </li>
        </ul>
        {Category === "bbook" ? (
