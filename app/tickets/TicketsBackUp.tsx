...
//           updatedFilter.airlines = updatedFilter.airlines.filter(
//             (airline: string) => airline !== value
//           );
//         } else {
...
//           // Remove the airline from the selected list
//           updatedFilter.returnAirlines = updatedFilter.returnAirlines.filter(
//             (returnAirlines: string) => returnAirlines !== value
//           );
//         } else {
//           // Add the airline to the selected list
...
//           // Remove the airline from the selected list
//           updatedFilter.fareIdentifier = updatedFilter.fareIdentifier.filter(
//             (fareIdent: string) => fareIdent !== value
//           );
//         } else {
//           // Add the airline to the selected list
...
//       // If any filters are active
//       if (
//         filter.returnAirlines?.length > 0 ||
//         filter.fareIdentifier?.length > 0
//       ) {
//         async function runFilter() {
...
//   async function filterTripInfosByAirlines(
//     tripInfos,
//     airlines = [],
//     fareIdentifiers = []
//   ) {
...
//     const result = Object.entries(tripInfos).reduce(
//       (acc, [tripKey, flights]) => {
//         const filteredFlights = (flights || []).filter((flight) => {
...
//                   fareIdsLower.includes(price.fareIdentifier.toLowerCase())
//               ));
...
//   async function filterTripInfosReturn(
//     tripInfos,
//     airlines = [],
//     fareIdentifiers = []
//   ) {
...
//                     </>
//                   ) : null}
//                   {tripPhaseFilter == "RETURN" &&
//                     returnUniqueAirlines &&
//                     returnUniqueAirlines.length > 0 && (
//                       <div className="sidebar-left border-1 background-body">
//                         <div className="box-filters-sidebar">
//                           <div className="block-filter border-1">
//                             <h6 className="text-lg-bold item-collapse neutral-1000">
