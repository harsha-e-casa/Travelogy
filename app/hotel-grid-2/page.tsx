        ...
        <main className="main">
                  ...
                  <div className="row">
                    {paginatedHotels.map((hotel) => (
                      <div
                        ...
                        key={hotel.id}
                      >
                        <HotelCard1 hotel={hotel} nights={1} />
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <section className="section-box box-media background-body">
            <div className="container-media wow fadeInUp">
              {" "}
              <img
                src="/assets/imgs/page/homepage5/media.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media2.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media3.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media4.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media5.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media6.png"
                alt="Travalogy"
              />
              <img
                src="/assets/imgs/page/homepage5/media7.png"
                alt="Travalogy"
              />
            </div>
          </section>
