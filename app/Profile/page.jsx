      ...
      <Layout headerStyle={1} footerStyle={1}>
        <main className="main">
          ...
          */}
              ...
              {/* Sidebar */}
              <div
                className="sidebar   w-full mb-30  bg-white rounded-2xl   shadow-lg border border-black"
                style={{
                  position: "sticky",
                  top: "5px",
                  height: "fit-content",
                  ...
                  <div className="bg-white rounded-2xl shadow-md">
                    <div className="p-4 space-y-4">
                      <div className="flex justify-between items-center">
                        <div>
                          <h4 className="text-bold neutral-1000 headings ">
                            Login Details
                          </h4>
                        </div>
                      </div>
                ...
                >
                  <div className="p-4">
                    <div className="flex flex-row justify-between items-center">
                      ...
                      <button
                        className="text-white rounded addTravelers"
