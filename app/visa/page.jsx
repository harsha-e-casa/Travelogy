...
const [isAccordion, setIsAccordion] = useState(0)
 ...
 useEffect(() => {
	...
	<Layout headerStyle={1} footerStyle={1}>		
			 <div className="pt-140 bg-white sm:pt-16 lg:pt-8 lg:pb-30 lg:overflow-hidden">
      ...
      <div className="mx-auto px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center text-center">
        <div className="pt-20 py-10">
          ...
          >
            ...
            <span className="ml-4 text-lg text-white">Track your visa status</span>
          ...
          <h1 className="mt-4 text-1x2 tracking-tight font-extrabold
           text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl py-2">
            <span className="block">Get a tourist visa,
quick and easy.</span>
                        ...
                        <h2 className="neutral-1000">How it works?</h2>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-1">
                                ...
                                <div className="card-info"> <Link className="text-xl-bold card-title" href="#">You submit the details
                                    ...
                                    <p className="text-sm-medium neutral-500 card-desc">This is a simple process that can be done entirely online.</p><Link className="text-sm-medium card-link" href="#">Learn More
                            ...
                            <div className="card-why-travel card-why-travel-2 background-2">
                                ...
                                <div className="card-info"> <Link className="text-xl-bold card-title" href="#">We work our magic
                                    ...
                                    <p className="text-sm-medium neutral-500 card-desc">We process your visa. Easily track progress via your account</p><Link className="text-sm-medium card-link" href="#">Learn More
                                        <svg width={11} height={10} viewBox="0 0 11 10"  xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.50011 9.08347L9.58347 5.00011L5.50011 0.916748M9.58347 5.00011L1.41675 5.00011" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg></Link>
                                </div>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-3">
                                ...
                                <div className="card-info"> <Link className="text-xl-bold card-title" href="#">You get your visa
                                    ...
                                    <p className="text-sm-medium neutral-500 card-desc">Get your visa, once it’s approved. It's that easy</p><Link className="text-sm-medium card-link" href="#">Learn More
                                        <svg width={11} height={10} viewBox="0 0 11 10"  xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.50011 9.08347L9.58347 5.00011L5.50011 0.916748M9.58347 5.00011L1.41675 5.00011" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg></Link>
                                </div>
                            ...
                            <div className="accordion" id="accordionFAQ">
                                <div className="accordion-item wow fadeInUp">
                                    ...
                                    <div className={isAccordion == 1 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
                                        <div className="accordion-body">Travalogy makes it easy for you to apply for your travel visa. Instead of spending hours trying to find information on the process and navigating embassy websites, you can answer a few easy questions on Travalogy and we apply for and manage the entire visa process on your behalf.</div>
                                    </div>
                                </div>
                                <div className="accordion-item wow fadeInUp">
                                    ...
                                    <div className={isAccordion == 2 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} id="collapseTwo" aria-labelledby="headingTwo" data-bs-parent="#accordionFAQ">
                                        <div className="accordion-body">Applying for visa with Travalogy is simple and quick. Answer a few basic questions about your trip, pay the visa fee and you are good to go. Certain embassy require additional travel documents for your trip. In such a case, post payment, you can upload the documents on our website or send them to us easily on WhatsApp.</div>
                                    </div>
                                </div>
                                <div className="accordion-item wow fadeInUp">
                                    ...
                                    <div className={isAccordion == 3 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionFAQ">
                                        <div className="accordion-body">Each country has its own timelines for approving the visa. Kindly select the country you’d like to go to to understand visa processing timelines.
</div>
                                    </div>
                                </div>
                                <div className="accordion-item wow fadeInUp">
                                    ...
                                    <div className={isAccordion == 4 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} id="collapseFour" aria-labelledby="headingFour" data-bs-parent="#accordionFAQ">
                                        <div className="accordion-body">We’re sorry for this. Travalogy currently only provides tourist visas to a few countries. We’ll be launching other countries and types of visas soon.</div>
                                    </div>
                                </div>
                                <div className="accordion-item wow fadeInUp">
                                    ...
                                    <div className={isAccordion == 5 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} id="collapseFive" aria-labelledby="headingFive" data-bs-parent="#accordionFAQ">
                                        <div className="accordion-body">For any other questions, WhatsApp us on +917550071116.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
