...
export default function HotelCard2({ hotel, nights }: any) {
	return (
		<>
			<div className="card-flight card-hotel background-card">
				<div className="card-image"> <Link className="wish" href="#">
					...
					</svg></Link><Link href="/hotel-detail"><img alt="travalogy" src={`/assets/imgs/page/homepage1/${hotel?.image}`} /></Link></div>
