                    ...
                    <div className="footer-top">
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-8 text-center text-md-end">
                                <div className="d-flex align-items-center justify-content-center justify-content-md-end"><Link className="text-md-medium need-help" href="#">Need help? Call us</Link><Link className="heading-6 phone-support" href="#">+91 9818739838</Link></div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
