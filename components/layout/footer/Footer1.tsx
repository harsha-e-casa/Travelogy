                    ...
                    <div className="footer-top">
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-8 text-center text-md-end">
                                <div className="d-flex align-items-center justify-content-center justify-content-md-end"><Link className="text-md-medium need-help" href="javascript:void(0)">Need help? Call us</Link><Link className="heading-6 phone-support" href="javascript:void(0)">+91 9818739838</Link></div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-3 col-sm-12 footer-1">
                            ...
                            <div className="mt-20 mb-20">
                                <div className="box-info-contact">
                                    <p className="text-md neutral-400 icon-address">Address: NPL Devi, 111, Lattice Brg Rd, Thiruvanmiyur, Chennai, Tamil Nadu 600041
                                    </p>
                                    <p className="text-md neutral-400 icon-worktime">Hours: 8:00 - 7:00, Mon - Fri</p>
                                ...
                                <div className="box-socials-footer"><Link className="icon-socials icon-instagram" href="javascript:void(0)">
                                    <svg width={20} height={20} viewBox="0 0 20 20"  xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg></Link><Link className="icon-socials icon-facebook" href="javascript:void(0)">
                                        <svg width={20} height={20} viewBox="0 0 20 20"  xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        </svg></Link><Link className="icon-socials icon-twitter" href="javascript:void(0)">
                                        ...
                                        </svg></Link><Link className="icon-socials icon-be" href="javascript:void(0)">
                        ...
                        <div className="col-md-2 col-xs-6 footer-2">
                            ...
                            <ul className="menu-footer">
                                <li><Link href="javascript:void(0)"> Help Center</Link></li>
                                <li><Link href="javascript:void(0)">Live chat</Link></li>
                                <li><Link href="javascript:void(0)">How it works</Link></li>
                                <li><Link href="javascript:void(0)">Security</Link></li>
                                <li><Link href="javascript:void(0)">Privacy</Link></li>
                                <li><Link href="javascript:void(0)">Charges logs</Link></li>
                            </ul>
                        </div>
                        <div className="col-md-2 col-xs-6 footer-3">
                            ...
                            <ul className="menu-footer">
                                ...
                                <li><Link href="javascript:void(0)">Community Blog</Link></li>
                                <li><Link href="javascript:void(0)">Jobs and Careers</Link></li>
                                <li><Link href="javascript:void(0)">Contact Us</Link></li>
                                <li><Link href="javascript:void(0)">Our Awards</Link></li>
                                <li><Link href="javascript:void(0)">Agencies</Link></li>
                            </ul>
                        </div>
                        <div className="col-md-2 col-xs-6 footer-4">
                            <h6 className="text-linear-3">Services</h6>
                            <ul className="menu-footer">
                                <li><Link href="javascript:void(0)">Tour Guide</Link></li>
                                <li><Link href="javascript:void(0)">Tour Booking</Link></li>
                                <li><Link href="javascript:void(0)">Hotel Booking</Link></li>
                                <li><Link href="javascript:void(0)">Ticket Booking</Link></li>
                                <li><Link href="javascript:void(0)">Rental Services</Link></li>
                            </ul>
                        </div>
                        <div className="col-md-3 col-xs-6 footer-5">
                            <h6 className="text-linear-3">Legal</h6>
                            <ul className="menu-footer">
                                <li><Link href="javascript:void(0)">Terms of Service</Link></li>
                                <li><Link href="javascript:void(0)">Privacy Policy</Link></li>
                                <li><Link href="javascript:void(0)">Cookies Policy</Link></li>
                                <li><Link href="javascript:void(0)">Data Processing</Link></li>
                                <li><Link href="javascript:void(0)">Data Policy</Link></li>
                                <li><Link href="javascript:void(0)">Refund Policy</Link></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 text-md-end text-center mb-20">
                                <ul className="menu-bottom-footer">
                                    ...
                                    <li> <Link href="javascript:void(0)">Privacy policy</Link></li>
                                    <li><Link href="javascript:void(0)">Legal notice</Link></li>
                                    <li><Link href="javascript:void(0)">Accessibility</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
