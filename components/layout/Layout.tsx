...
import CorporateSignin from "./CorporateSignin";
...
export default function Layout({
  ...
  const [isCorporateLogin, setCorporateLogin] = useState<boolean>(false);
  const handleLogin = (): void => setLogin(!isLogin);
  const handleCorporateLogin = (): void => setCorporateLogin(!isCorporateLogin);
  // Register
    ...
    <>
      ...
      {headerStyle == 1 ? (
        <Header1
          ...
          handleCorporateLogin={handleCorporateLogin}
