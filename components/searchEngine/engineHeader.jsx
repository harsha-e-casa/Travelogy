...
const EngineTabs = () => {
  ...
  useEffect(() => {
    ...
    if(datedep){
      ...
      setDd_year(formattedDate.format('MMM')); // Format as string
    }
  ...
  useEffect(() => {
    ...
    if(datedepr && selectedPlan === 'round-trip'){
      ...
      setDdr_year(formattedDateR.format('MMM')); // Format as string
    }
...
>
  ...
  {/*  <div className="plans mt-35 mb_8 ml_10">
    ...
    <div className="custom-grid justify-center">
      ...
      <div className="text_start b_right_2px g_w_1 css_pointer relative">
 ...
 <div className="searchReplaceLocation">
    ...
    Departure Date
      ...
      <div className="b_right_2px g_w_5 css_pointer">
