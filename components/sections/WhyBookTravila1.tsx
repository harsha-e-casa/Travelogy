export default function WhyBookTravelogy1() {
    return (
        <>

            <section className="section-box box-why-book-Travelogy background-body">
                <div className="container">
                    <div className="text-center wow fadeInUp">
                        <h2 className="neutral-1000">Why book with Travelogy?</h2>
