  ...
  <div className="main_d2l_section p-8 pt-4">
    <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-4 lg:max-w-none">
      <div className="flex flex-col ">
        ...
        src="https://images-cf.ixigo.workers.dev/v2/images_by_id/503b2a92e4b032e338f13fd5.jpg?cityName=Bathinda"
        alt=""> </div>
    <div class="flex-1 bg-white p-3 flex flex-col justify-between">
      <div class="flex-1">
        <p class="text-sm font-medium text-indigo-600">
          <a href="#" class="hover:underline"> Sun, 02 Feb </a>
        </p> <a href="#" class="block">
          <p class="text-xl font-semibold text-gray-900">Bathinda , Punjab</p>
        </a>
      </div>
      <div class="mt-6 flex items-center relative">

        <div class="flex items-center w-full justify-between">
          <div>
            <span class="text-bold font-bold text-gray-900">
              ₹2,100
            </span>
          ...
          <div class="p-3 rounded-lg text-sm font-bold text-black br_ddke23">
            Book Flight
          </div>
        </div>
